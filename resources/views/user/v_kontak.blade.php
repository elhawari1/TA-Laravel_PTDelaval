    ...
    <div class="container">
        <div class="row block-9">
            <div class="col-md-6 order-md-last d-flex">
                <form action="/kontak/insert" method="POST" enctype="multipart/form-data" class="bg-white p-5 contact-form">Kirim pesan anda<br><br>
                    @csrf
                    ...
                    <div class="form-group">
                        <input type="text" name="telepon" class="form-control" placeholder="Telepon" value="{{ old('email') }}">
                        <div class="text-danger">
                            @error('telepon')
                            {{ $message }}
                            @enderror
