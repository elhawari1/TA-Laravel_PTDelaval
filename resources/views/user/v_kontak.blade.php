            ...
            <div class="row no-gutters ftco-services">
                <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services mb-md-0 mb-4">
                        <div style="background-color:#e7e4ee"
                            class="icon active d-flex justify-content-center align-items-center mb-2">
                            <i class="fas fa-map-marker-alt fa-3x"></i>
                        </div>
                        <div class="media-body">
                            <h3 class="heading">Alamat</h3>
                            <span>Perum Bukit Hijau Blok B-Kav.39,Jalan Raya Tlogomas, Kec. Lowokwaru, Kota Malang, Jawa
                                Timur 65144</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services mb-md-0 mb-4">
                        <div style="background-color:#e7e4ee"
                            class="icon d-flex justify-content-center align-items-center mb-2">
        ...
        <div class="container">
            <div class="row block-9">
                <div class="col-md-6 order-md-last d-flex">
                    <form action="/kontak/insert" method="POST" enctype="multipart/form-data"
                ...
                <div class="col-md-6 d-flex">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3951.6763924027964!2d112.59994311407603!3d-7.92882769428862!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e78821ef791cf69%3A0xa6e62980c560a9b5!2sDelaval%20Indonesia%20(Agri%20Servis%20Sakti.%20PT)!5e0!3m2!1sen!2sid!4v1619773876914!5m2!1sen!2sid"
